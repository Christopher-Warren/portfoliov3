    ...
    <div className="flex justify-between lg:w-4/5 w-11/12 mx-auto">
      ...
      >
        ...
        <li className="pl-4 pr-4">
          <a href="https://github.com/Christopher-Warren" aria-label="github">
            <svg
              className="w-8"
              fill="currentColor"
              ...
              viewBox="0 0 24 24"
            >
              <title id="githubsvg">github svg</title>
        ...
        <li className="">
          <div className="relative inline-block w-12 mr-2 align-middle select-none transition duration-200 ease-in">
            {/* <label
              htmlFor="toggle"
              id="darkmode-toggle"
              className={`inline whitespace-nowrap text-sm absolute bottom-6 left-1 border border-red-500`}
            ></label> */}
            <div
